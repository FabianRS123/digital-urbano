...
// El registro de mapcn apunta el worker a unpkg. Aquí se sirve desde el
// propio bundle para no depender de una CDN externa (entornos sin salida a
// internet, CSP restrictiva o unpkg caído dejaban el mapa cargando para
// siempre).
...
type MapProps = {
   ...
   * basemap â€” a blank canvas. Used alone it renders nothing; add your own
 ...
 * `MapRoute` / `MapArc` â€” drop it inside `<Map>` (typically with `blank`) for
...
type MapArcProps<T extends MapArcDatum = MapArcDatum> = {
   ...
   * side. Arcs are computed as a quadratic BÃ©zier in lng/lat space; the
